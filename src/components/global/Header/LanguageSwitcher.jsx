  ...
  return (
    <div className="relative z-50 group">
      ...
      <button
        ...
        className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/10 backdrop-blur-lg border border-primary/20 hover:border-primary/50 hover:bg-white/20 transition-all duration-300 shadow-[0_4px_15px_rgba(0,0,0,0.05)] cursor-pointer relative overflow-hidden active:scale-95"
      >
        <motion.div 
          animate={{ 
            rotate: isOpen ? 180 : 0,
        ...
        {isOpen && (
          <>
            <motion.div
              ...
              className="absolute right-0 mt-4 w-44 bg-white/95 backdrop-blur-2xl border border-primary/10 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] overflow-hidden p-1.5 z-50"
            >
              <div className="relative space-y-1">
                {languages.map((lang) => (
                  ...
                  >
                    ...
                    {(hoveredCode === lang.code || currentLang.code === lang.code) && (
                      <motion.div
