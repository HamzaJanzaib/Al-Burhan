...
const Counter = ({ value, suffix = "%" }) => {
  ...
  return <span ref={ref} className="text-6xl font-black tracking-tighter text-secondary">0{suffix}</span>;
};
...
const AboutStatsSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full bg-white py-24 px-6 lg:px-16 overflow-hidden">
      ...
      >
        ...
        <div className="space-y-12">
          <motion.div style={{ y: imgY }} variants={itemVariants} className="relative group">
            {/* Interactive Frame */}
            ...
            <div className="relative aspect-[4/5] md:aspect-square overflow-hidden rounded-[40px] shadow-2xl border border-white">
              ...
              <motion.div 
                ...
                className="absolute bottom-8 left-8 bg-white/95 backdrop-blur-md p-5 rounded-3xl shadow-xl border border-primary/10 flex items-center gap-4"
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-primary">Certified Tutors</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-2 gap-12 pt-4">
            {[ 
              { val: 98, suffix: "%", text: "Student satisfaction rate in our Hifz and Tajweed programs." },
              { val: 1200, suffix: "+", text: "Students who have successfully completed their Quran course." }
            ].map((stat, i) => (
                ...
                <div className="flex flex-col">
                  ...
                  <div className="w-full h-2 bg-slate-100 mt-4 relative rounded-full overflow-hidden">
                     <motion.div 
                      ...
                      transition={{ duration: 2, ease: [0.16, 1, 0.3, 1], delay: 0.5 + i * 0.2 }}
                      viewport={{ once: true }}
        ...
        <div className="flex flex-col space-y-12">
          <motion.div variants={itemVariants} className="space-y-8">
            ...
            <h2 className="text-5xl lg:text-7xl font-black text-slate-900 leading-[1.05] tracking-tight">
              Empowering the <span className="text-primary italic">Next Generation</span> of Huffaz.
            </h2>
            
            <p className="text-slate-600 leading-relaxed text-xl font-medium">
              We go beyond recitation. We instill the values of the Quran into the hearts of our students, building a legacy of faith and character.
            </p>
          ...
          >
            <Link href="/enroll">
              ...
              >
                ...
                <Image src="/al-burhan/Logo/WEBP/al-burhan-full.webp" alt="Join Us" fill className="object-cover transition-transform duration-1000 group-hover:scale-110" />
                
                {/* Overlay CTA */}
                <div className="absolute inset-x-0 bottom-0 p-8 z-20 bg-linear-to-t from-black/60 to-transparent">
                   <div className="flex items-center justify-between">
                     <p className="text-white font-bold text-xl">Start Your Trial Today</p>
