...
import { CheckCircle, Clock, Users, Star, ChevronRight, BookOpen, Heart, Award } from "lucide-react";
    ...
    <div className="min-h-screen bg-background overflow-hidden pb-20">
      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            Perfect your pronunciation and recite the Holy Quran with the beauty and precision it deserves. 
            Our expert tutors guide you through every rule with live, interactive sessions.
          </motion.p>
          <motion.div
          ...
          >
            <Link href="/enroll?course=Tajweed Al-Quran" className="px-10 py-4 rounded-full bg-secondary text-primary font-bold shadow-xl hover:scale-105 active:scale-95 transition-all">
              Enroll Now
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-black text-primary mb-8 border-l-4 border-secondary pl-4">Course Curriculum</h2>
          ...
          <div className="space-y-8">
            <div className="p-10 rounded-[40px] bg-primary text-white relative overflow-hidden">
              ...
              <h3 className="text-2xl font-black mb-8 relative z-10">Learning Outcomes</h3>
              <ul className="space-y-6 relative z-10">
                {["Master 28 Articulation Points", "Apply Ghunnah & Ikhfa", "Perfect Madd Pro-longation", "Oral Assessment & Exam", "Recitation Certification"].map(item => (
            ...
            <div className="p-10 rounded-[40px] border-2 border-slate-100 bg-slate-50/50">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Start with a Trial</h3>
              <p className="text-slate-500 text-sm mb-8 leading-relaxed">
                Experience the teaching style of our expert tutors with a 3-day free trial class. No credit card required.
              </p>
              <Link href="/enroll" className="inline-flex items-center gap-2 font-black text-primary hover:text-secondary transition-colors group">
