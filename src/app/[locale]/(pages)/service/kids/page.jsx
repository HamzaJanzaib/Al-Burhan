...
const steps = [
  {
    num: "01",
    title: "Fun with Arabic Letters",
    desc: "Interactive alphabet learning using storytelling and colorful visuals designed for kids.",
  },
  {
    num: "02",
    title: "Basic Qaida Mastery",
    desc: "Patiently building the foundation of Quranic reading through engaging, short lessons.",
  },
  {
    num: "03",
    title: "Short Surah Memorization",
    desc: "Helping kids memorize beautiful short Surahs with perfect pronunciation from an early age.",
  },
  {
    num: "04",
    title: "Islamic Manners (Akhlaq)",
    desc: "Teaching basic Sunnah prayers and daily Islamic etiquette in a fun environment.",
  },
  {
    num: "05",
    title: "Interactive Quiz Games",
    desc: "Testing knowledge through educational games that keep children excited about learning.",
  },
  {
    num: "06",
    title: "Kid's Certification",
    desc: "Celebrating progress with colorful certificates and positive reinforcement.",
  },
];
      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-primary">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-background/20 backdrop-blur-md border border-white/40 text-primary text-xs font-black uppercase tracking-widest mb-6"
          >
          ...
          >
            A playful and gentle introduction to the Holy Quran. We make
            learning a joyful experience for your little ones through
            storytelling, games, and patient tutoring.
          </motion.p>
          <motion.div
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {steps.map((step, i) => (
                <motion.div
                  ...
                  className="group p-8 rounded-[32px] bg-background border border-slate-100 shadow-sm hover:shadow-xl hover:border-secondary/30 transition-all cursor-pointer"
                >
          ...
          <div className="space-y-8">
            <div className="p-10 rounded-[40px] bg-linear-to-br from-[#0d5c5c] to-[#0a4545] text-white relative overflow-hidden shadow-2xl">
              ...
              <ul className="space-y-6 relative z-10">
                {[
                  "Patient & Loving Tutors",
                  "Educational Visual Aids",
                  "Progress Incentives",
                  "Flexible timings for school",
                  "Secure Parental Tracking",
                ].map((item) => (
            ...
            <div className="p-10 rounded-[40px] border-2 border-slate-100 bg-slate-50/50">
              ...
              <p className="text-slate-500 text-sm mb-8 leading-relaxed font-medium">
                {" "}
                We prioritize your child's emotional and spiritual growth
