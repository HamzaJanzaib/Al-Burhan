    ...
    <div className="min-h-screen bg-background overflow-hidden pb-20">
      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <Link href="/enroll?course=Quran Reading (Nazra)" className="px-10 py-4 rounded-full bg-primary text-white font-bold shadow-xl hover:scale-105 active:scale-95 transition-all">
              Book Trial Class
            </Link>
          </motion.div>
        </div>
