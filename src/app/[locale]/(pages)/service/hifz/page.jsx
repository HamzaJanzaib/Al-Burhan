...
const steps = [
  { num: "01", title: "Initial Assessment", desc: "Evaluate the student's existing reading level and memory ability." },
  { num: "02", title: "Surah Selection & Planning", desc: "Create a personalized Hifz plan starting from Juz Amma." },
  { num: "03", title: "Daily Memorization (Sabaq)", desc: "Set and memorize a daily portion under tutor supervision." },
  { num: "04", title: "Recent Revision (Sabaq Para)", desc: "Revise the last 7-10 days of memorization in every session." },
  { num: "05", title: "Old Revision (Manzil)", desc: "A structured plan to revise all previously memorized portions weekly." },
  { num: "06", title: "Full Hifz Testing", desc: "Final examination with certified Hafiz assessor and issuance of Ijazah." },
];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="flex-1">
            ...
            <h1 className="text-5xl font-bold text-primary mb-5 leading-tight">
              Quran <span className="text-secondary">Memorization</span> (Hifz)
            </h1>
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Become a Hafiz-ul-Quran with our structured, one-on-one online program — designed for children and adults alike, guided by experienced Huffaz.
            </p>
            <div className="flex flex-wrap gap-6 mb-8">
              {[["All Ages", <Users size={16} />], ["Personalized Plan", <Clock size={16} />], ["Hafiz Certified", <Star size={16} />]].map(([label, icon]) => (
          ...
          >
            ...
            <ul className="space-y-3">
              {["Structured Sabaq system", "Daily & weekly revision", "Tajweed during Hifz", "Memory enhancement techniques", "Full Quran memorization", "Ijazah certification"].map((item) => (
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-primary text-center mb-12">Our Hifz Program Structure</h2>
      ...
      <section className="py-16 px-6 text-center bg-muted/30">
        <h2 className="text-3xl font-bold text-primary mb-4">Start Your Hifz Journey</h2>
        <p className="text-muted-foreground mb-8">Join hundreds of students who have completed their Hifz with AL Burhan Academy.</p>
