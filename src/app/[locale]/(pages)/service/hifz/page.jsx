...
const steps = [
  {
    num: "01",
    title: "Internalizing Intention",
    desc: "Setting a pure spiritual intention and understanding the rewards of preserving the Quran.",
  },
  {
    num: "02",
    title: "Initial Assessment",
    desc: "Detailed evaluation of current reading level and memorization capacity.",
  },
  {
    num: "03",
    title: "Structured Memorization",
    desc: "Surah-by-Surah learning with personalized daily targets tailored to your pace.",
  },
  {
    num: "04",
    title: "Revision (Daur)",
    desc: "Systematic revision of old parts to ensure long-term retention in the heart.",
  },
  {
    num: "05",
    title: "Testing & Consolidation",
    desc: "Periodic oral examinations to verify the strength of your memorization.",
  },
  {
    num: "06",
    title: "Certification",
    desc: "Comprehensive final assessment and receipt of your Hifz completion certificate.",
  },
];
    ...
    <div className="min-h-screen bg-background overflow-hidden pb-20">
      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            Become a Hafiz of the Holy Quran. Our structured program ensures you
            memorize and retain every Ayah for life with specialized revision
            techniques.
          </motion.p>
          <motion.div
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-black text-primary mb-8 border-l-4 border-secondary pl-4 uppercase tracking-tight">
              The Memorization Path
            </h2>
            <div className="grid sm:grid-cols-2 gap-6">
              {steps.map((step, i) => (
                ...
                >
                  <span className="block text-4xl font-black text-[#0d5c5c]/10 group-hover:text-secondary/20 transition-colors mb-4">
                    {step.num}
                  </span>
          ...
          <div className="space-y-8">
            ...
            <div className="p-10 rounded-[40px] border-2 border-slate-100 bg-slate-50/50">
              ...
              <p className="text-slate-500 text-sm mb-8 leading-relaxed">
                {" "}
                Our Hifz program is taught by certified Huffaz with years of
